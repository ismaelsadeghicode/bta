...
<table id="table-bgs">
    ...
    <c:forEach items="${flights}" var="flight">
        <tr>
            ...
            <td class="column8"><a href="<c:url  value="/home/flight/description/${flight.id}&${account.id}" />">Description</a></td>
            <td  class="column9"><button style="width:90px;height: 32px;background-color: darkred   " class="btn btn-info"><a style="text-decoration:none;color: whitesmoke" href="<c:url value="/home/flight/${flight.id}" />">Add to cart</a></button></td>
        </tr>
    </c:forEach>
    </tbody>
</table>
