    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tr>
                ...
                <td>${flight.unitPrice}</td>
                <td>
                    <c:choose>
                        <c:when test="${flight.status=='true'}">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-patch-check"
                        ...
                        <c:otherwise>
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-patch-minus"
                                 fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
...
<div>
    <center>
        <h2>price: </h2>
        <h3 style="color: #922b21 ">${flight.unitPrice} $</h3>
    </center>
    <center>
        <h2>Description:</h2>
        <br/>
